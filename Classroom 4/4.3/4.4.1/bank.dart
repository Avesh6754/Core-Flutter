...
class Bank 
{
  ...
  Bank({required this.address,required this.age,required this.balance,required this.company,required this.email,required this.eyeColor,required this.gender,required this.isActive,required this.name,required this.phone});
}
List Newdata=[];
...
main()
{
  ...
  for(int i=0;i<Newdata.length;i++)
  {
    ...
    print("\n\n\nBank Data ${i+1}:  Name : ${Newdata[i].name}"+" "+"age : ${Newdata[i].age}"+" "+"eyeColor : ${Newdata[i].eyeColor}"+" "+"balance : ${Newdata[i].balance}"+" "+"isActive : ${Newdata[i].isActive}"+" "+"gender : ${Newdata[i].gender}"+" "+"company : ${Newdata[i].company}"+" "+"address : ${Newdata[i].address}"+" "+"phone : ${Newdata[i].phone}"+" "+"email : ${Newdata[i].email}\n\n");
  }
}
