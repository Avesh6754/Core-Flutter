...
class Bank{
  ...
  {
    return Bank(name: m1['name'],email: m1['email'],age: m1['age'],isActive: m1['isActive'],balance: m1['balance'], gender: m1['gender'], eyeColor: m1['eyeColor'],company: m1['company'],phone: m1['phone'],address: m1['address']);
  }
...
void main()
{
  int i=1;
  List<Bank> l1=[];
  for (var x in bankData) {
    Bank s1=Bank.fromMap(x);
    l1.add(s1);
    
  }

  for (var data in l1) {
    print("Bank Customer details : $i ");
